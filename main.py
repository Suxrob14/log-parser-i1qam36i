    ...
    Log Parser I1qam36i
    ===================
    Zero-dependency command-line tool designed to inspect local resources efficiently.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Zero-dependency command-line tool designed to inspect local resources efficiently.")
